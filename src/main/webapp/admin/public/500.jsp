    ...
    <div class="ivu-exception">
        <div class="ivu-exception-img">
            <div class="ivu-exception-img-element">
                <img src="admin/images/icon-500.svg" WIDTH="100%" HEIGHT="100%">
            </div>
        </div>
        <div class="ivu-exception-content"><h1>500</h1>
            <div class="ivu-exception-content-desc">抱歉，服务器出错了</div>
            <div class="ivu-exception-content-actions">
                <a href="Admin/Index/index"
                   class="ivu-btn ivu-btn-primary ivu-btn-large"><!----> <!---->
                    <span>返回首页</span></a></div>
        </div>
    </div>
</div>
<script>
