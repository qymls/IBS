...
<div id="app">
    ...
    <Card>
        ...
        <Row justify="center" align="middle">
            <div style="margin-top:20px">
                <i-Table :columns="columns" :data="DepotData" border max-height="650"
            ...
            <Modal title="添加信息" v-model="updateModel" class-name="vertical-center-modal" footer-hide draggable>
                <i-Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
                    ...
                    <Form-Item label="最大数量" prop="maxcapacity">
                        <i-Input v-model="formValidate.maxcapacity" placeholder="请输入相关值"></i-Input>
                    </Form-Item>
                    <Form-Item label="当前数量" prop="currentcapacity">
                        <i-Input v-model="formValidate.currentcapacity" placeholder="请输入相关值"></i-Input>
                    </Form-Item>
                    <Form-Item label="总和小计" prop="totalamount">
                        <i-Input v-model="formValidate.totalamount" placeholder="请输入相关值"></i-Input>
                    </Form-Item>
                    <Form-Item>
    ...
    <script src="admin/depot/depot.js" type="module"></script>
</div>