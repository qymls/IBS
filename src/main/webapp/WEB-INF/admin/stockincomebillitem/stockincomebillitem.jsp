...
<div id="app">
    ...
    <Card>
        ...
        <Row>
            <i-col span="3">
                ...
                <Poptip
                        ...
                        transfer
                        title="您确认删除这些信息吗?"
                        @on-ok="deleteStockincomebillitem">
        ...
        <Row justify="center" align="middle">
            <div style="margin-top:20px">
                <i-Table :columns="columns" :data="StockincomebillitemData" border max-height="650"
    ...
    <script src="admin/stockincomebillitem/stockincomebillitem.js" type="module"></script>
</div>