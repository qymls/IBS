            ...
            <Modal v-model="updateModel" class-name="vertical-center-modal" width="1250" draggable :scrollable="true">
                ...
                <Card :bordered="false">
                    <template>
                        ...
                        <i-Table :columns="detailscolumns" :data="detaildata" style="margin-top: 10px;" height="375" class="details"
                                 border>
                            ...
                            <template slot-scope="{ row, index }" slot="price">
                                <template v-if="editIndex === index">
                                    <Input-Number :min="0.0" :step="0.1" v-model="detaileformSave.price"
                                                  v-model="detaileformSave.price" @on-change="priceChange(detaileformSave.price)"/>
                                </template>
                            ...
                            <template slot-scope="{ row, index }" slot="num">
                                <template v-if="editIndex === index">
                                    <Input-Number :min="0.0" :step="0.1" v-model="detaileformSave.num" @on-change="numChange(detaileformSave.num)"/>
                                </template>
