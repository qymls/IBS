...
public class PurchasebillQuery extends BaseQuery<Purchasebill> {
    ...
    public Specification getSpecification() {
        PredicateBuilder<Purchasebill> and = Specifications.and();
        and.eq(supplierId != null && supplierId > 0, "supplier.id", supplierId);
        and.eq(buyerId != null && buyerId > 0, "buyer.id", buyerId);
        ...
        Specification<Purchasebill> specification = and.build();
